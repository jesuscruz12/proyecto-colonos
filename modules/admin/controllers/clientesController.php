<?php
// C:\xampp\htdocs\qacrmtaktik\modules\admin\controllers\clientesController.php
...
class clientesController extends adminController
{
    ...
    public function __construct()
    {
        ...
        $this->_m = $this->loadModel('clientes');
    }
    ...
    {
        $id = (int)($_GET['id'] ?? 0);
        $r  = $this->_m->getCli($this->empresaId(), $id);
    ...
    {
        try {
            $id = $this->_m->saveCli($this->empresaId(), $_POST);
            $this->json(['ok'=>true,'id'=>$id,'msg'=>'Guardado']);
        } catch(Throwable $e) {
            $this->json(['ok'=>false,'msg'=>$e->getMessage()], 400);
        }
    }
    ...
    public function delete()
    {
        try {
            ...
            $this->_m->deleteCli($this->empresaId(), $id);
